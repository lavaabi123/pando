...
<form class="actionForm" action="{{ module_url("save") }}" method="POST" data-redirect="{{ module_url(); }}">
    <div class="container max-w-800 pb-5">
         ...
         <div class="mb-5 bg-white border rounded-5 p-4 inputField">
            @if($result)
            ...
            <div class="border border-gray-300 b-r-15 mb-3">
            ...
            <div class="border border-gray-300 b-r-15 mb-3">
                ...
                <div class="">
                    ...
                    <div class="px-4 pb-4">
                        <button type="button" class="btn btn-dark w-100 addSpecificTimes">
                    ...
                    <div class="p-3 overflow-x-auto">
                        <div class="d-flex gap-8 min-w-400">
                            ...
                            <label for="{{ $value }}" class="flex-fill w-100 ratio-1x1 b-r-15 border-2 py-4 text-center bg-active-primary fw-6">
                                {{ __($value) }}  
