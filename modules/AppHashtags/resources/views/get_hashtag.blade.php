<div class="offcanvas offcanvas-end border-start" data-bs-backdrop="false" tabindex="-1" id="getHashtagOffCanvas">
    ...
    <div class="offcanvas-body p-0">
        <form method="POST">
            <div class="ajax-scroll-9" data-url="{{ route("app.hashtags.popup_list") }}" data-resp=".hashtag-list" data-scroll=".offcanvas-body">
