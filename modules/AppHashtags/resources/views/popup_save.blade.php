<div class="modal fade" id="saveHashtagModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="{{ module_url("save") }}" data-call-success="Main.closeModal('saveHashtagModal');">
 				...
 				<div class="row">
 					<div class="col-md-12">
 						<div class="mb-0">
	                     	...
	                     	<textarea class="form-control hashtag-content d-none" name="content"></textarea>
		                </div>
 					</div>
 				</div>
