<div class="offcanvas offcanvas-end border-start" data-bs-backdrop="false" tabindex="-1" id="getApprovalOffCanvas">
    <div class="offcanvas-header border-bottom pt-23 pb-22">
        <div class="fw-5">{{ __("List approval") }}</div>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body p-0">
        <form method="POST">
            <div class="ajax-scroll-9" data-url="{{ route("app.approvals.popup_list") }}" data-resp=".approval-list" data-scroll=".offcanvas-body">
