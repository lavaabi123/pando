@if(!empty($captions))
						@foreach($captions as $brand)
							...
							<div class="brand-actions">
								...
								<a title="Delete Brand" class="btn brand-action-btn actionItem" href="{{ route("app.brands.destroy") }}" data-confirm="Are you sure?" data-id="{{ $brand->id_secure }}" data-call-success="Main.ajaxScroll(true,'brands');">
