...
@section('sub_header')
    <x-sub-header
        ...
        description="{{ __('Effortlessly Manage and Organize All Your Replies') }}"
        :count="$total"
    >
        <div class="d-flex gap-8">
            <a class="btn btn-dark btn-sm actionItem" href="{{ module_url("update") }}" data-popup="replyModal" data-call-success="Main.ajaxScroll(true);">
...
<div class="container pb-3">
    ...
    <div class="container px-4">
        ...
        <div class="ajax-scroll" data-url="{{ module_url("list") }}" data-resp=".reply-list" data-scroll="document">
