<div class="modal fade" id="replyModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<form class="modal-content actionForm" action="{{ module_url("save") }}" data-call-success="Main.closeModal('replyModal'); Main.ajaxScroll(true);">
			<input type="text" class="d-none" name="type" value="0">
			<div class="modal-header">
				<h1 class="modal-title fs-16">{{ __("Create reply") }}</h1>
			...
			<div class="modal-body">
		    	...
		    	<input class="d-none" name="id_secure" type="text" value="{{ data($result, "id_secure") }}">
 				...
 				<div class="row">
 					...
 					<div class="col-md-12">
 						<div class="mb-4">
		                  	<label for="content" class="form-label">{{ __('Replies') }}</label>
	                     	<textarea  class="form-control input-emoji" name="content" id="content" placeholder="{{ __('Enter reply') }}">{{ data($result, "content") }}</textarea>
		                </div>
 					</div>
 				</div>
