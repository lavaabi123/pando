<div class="step-content step-2 hidden">
    ...
    ?>
    <input type="hidden" id="all-passed" value="<?php echo e($all_passed ? 1 : 1); ?>">
    <?php if(!$all_passed): ?>
...
</div><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/installer/views/steps/step2.blade.php ENDPATH**/ ?>