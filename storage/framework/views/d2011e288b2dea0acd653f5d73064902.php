...
<div class="container w-100 pb-5 pt-5">
    <div class="row gy-4">
        <div class="col-lg-8 col-md-12">
            <div class="card">
                <div class="card-body px-5 py-5">
                    <div class="mb-4">
                        <h2 class="fw-bold text-primary mb-4"><?php echo e(__("Earn with our affiliate program")); ?></h2>
                        <p class="my-2 text-gray-700"><?php echo e(__("Your rewards will continue as long as their subscription remains active. You will receive a commission on each qualifying purchase at: :pecent%", ["pecent" => get_option("affiliate_commission_percentage", 15)])); ?></p>
                    </div>

                    <div class="mb-4">
                        <label class="form-label text-dark fw-bold"><?php echo e(__("Affiliate Link")); ?></label>
                        <div class="input-group mb-2">
                            <input id="affiliate-link" class="form-control input-group" disabled type="text" value="<?php echo e(url("?ref=".Auth::user()->id_secure )); ?>">
                            <button class="btn btn-dark" onclick="Main.copyToClipboard('#affiliate-link')"><?php echo e(__('Copy')); ?></button>
                        </div>
                        <?php
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-2 fs-14 text-gray-800"><?php echo e(__("Share a link on:")); ?></div>
                            <div>
                                <span class="me-1">
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e($encodedUrl); ?>" target="_blank" rel="noopener">
                                        <i class="text-dark fs-4 fa-brands fa-square-facebook"></i>
                                    </a>
                                </span>
                                <span class="me-1">
                                    <a href="https://twitter.com/intent/tweet?url=<?php echo e($encodedUrl); ?>" target="_blank" rel="noopener">
                                        <i class="text-dark fs-4 fa-brands fa-square-x-twitter"></i>
                                    </a>
                                </span>
                                <span class="me-1">
                                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e($encodedUrl); ?>" target="_blank" rel="noopener">
                    ...
                    <form class="actionForm" method="POST" action="<?php echo e(route('app.send-affiliate')); ?>">
                        <?php echo csrf_field(); ?>
                        <label class="form-label fw-bold text-dark"><?php echo e(__("Send an invitation via email")); ?></label>
                        <div class="input-group">
                            <input name="email" class="form-control" placeholder="<?php echo e(__('Enter Email Address')); ?>" type="email" required>
                            <button class="btn btn-dark" type="submit"><?php echo e(__("Send")); ?></button>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="row gx-0">
                        ...
                        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-12">
                                <div class="p-4 border-top hp-100 <?php echo e($step['num'] != 3?"border-end":""); ?>">
                                    <div class="d-flex flex-column mb-2">
                                        <div class="step-num mb-3 d-flex align-items-center justify-content-center bg-gray-100 size-50 b-r-100 text-dark border border-gray-900">
                                            <i class="<?php echo e($step['icon']); ?> fs-3"></i>
                                        </div>
                                        <div class="fw-6 fs-14 mb-2 text-dark">
                                            <?php echo e($step['title']); ?>

                                        </div>
                                        <div class="text-gray-700 fs-12"><?php echo e($step['desc']); ?></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body px-0 py-5 d-flex flex-column">
                    <div class="mb-0">
                        <div class="d-flex flex-column align-items-center justify-content-center mb-3 gap-1">
                            ...
                            <div class="fw-bold fs-20 mb-1"><?php echo e(__("Your Balance")); ?></div>
                        </div>
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            <div class="mb-5 mt-5">
                                <div class="fs-55 fw-bold text-primary"><?php echo e(Core::currency(($affiliate_info["total_balance"]))); ?></div>
                            </div>
                    ...
                    <div class="mt-auto">
                        <div class="d-flex flex-column mt-3 w-100 align-items-center border-top border-dashed">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100 border-bottom border-dashed px-4 py-2">
                                <span class="size-25 <?php echo e($item['text']); ?>"><i class="<?php echo e($item['icon']); ?>"></i></span>
                                <span class="fs-14"><?php echo e($item['label']); ?></span>
                                <span class="ms-auto fs-14 fw-6">
                                    <?php echo e(Core::currency(($item['value']))); ?>
                        ...
                        <div class="text-center pt-3">
                            <a href="<?php echo e(url('terms-of-service')); ?>" class="text-dark text-decoration-underline fs-15" target="_blank" rel="noopener">
                                <?php echo e(__("Learn more about our conditions")); ?>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="card overflow-hidden hp-100">
                <div class="card-header">
                    <div>
                        <div class="fw-5"><?php echo e(__("Your referral stats")); ?></div>
                        <div class="text-gray-600 fs-14">
                            <?php echo e(__('See detailed statistics about your affiliate performance')); ?>
                ...
                <div class="card-body p-0">
                    <table class="table mb-0">
                        <tbody>
                            <tr>
                                <th scope="row"><?php echo e(__("Clicks")); ?></th>
                                <td class="fs-14"><?php echo e(__("Total times your affiliate link was visited by potential users.")); ?></td>
                                <td class="border-start text-end fw-6 fs-14"><?php echo e(number_format($affiliate_info["total_clicks"])); ?></td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo e(__("Conversions")); ?></th>
                                <td class="fs-14"><?php echo e(__("Number of successful sign-ups and purchases through your link.")); ?></td>
                                <td class="border-start text-end fw-6 fs-14"><?php echo e(number_format($affiliate_info["total_conversions"])); ?></td>

                            </tr>
                            <tr>
                                <th scope="row"><?php echo e(__("Pending")); ?></th>
                                <td class="fs-14"><?php echo e(__("Earnings that are awaiting verification or approval before payout.")); ?></td>
                                <td class="border-start text-end fw-6 fs-14"><?php echo e(Core::currency(($affiliate_info["pending_commission"]))); ?></td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo e(__("Approved")); ?></th>
                                <td class="fs-14"><?php echo e(__("Earnings that have been approved and are ready for payout.")); ?></td>
                                <td class="border-start text-end fw-6 fs-14"><?php echo e(Core::currency(($affiliate_info["approved_commission"]))); ?></td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo e(__("Rejected")); ?></th>
                                <td class="fs-14"><?php echo e(__("Commissions that were rejected or cancelled.")); ?></td>
                                <td class="border-start text-end fw-6 fs-14"><?php echo e(Core::currency(($affiliate_info["rejected_commission"]))); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="col-lg-4 col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="fw-5"><?php echo e(__("Withdrawal Request")); ?></div>
                </div>
                <div class="card-body">
                    <form class="actionForm" action="<?php echo e(module_url("withdrawal-request")); ?>" data-confirm="<?php echo e(__("I confirm that all provided info is accurate")); ?>">
                        <div class="mb-3">
                            <label class="form-label input-group"><?php echo e(__("Your Bank Information")); ?></label>
                            <textarea class="form-control" id="bank" name="bank" type="text" value=""></textarea>
                        </div>
                        <div class="">
                            <label class="form-label input-group"><?php echo e(__("Amount ($)")); ?></label>
                            <input class="form-control input-group mb-3" placeholder="<?php echo e(__('Minimum Amount Withdrawal is :amount', ['amount' => '$' . Affiliate::info('min_withdrawal')])); ?>" type="number" id="amount" name="amount" step="any" min="0.01" value="">
                            <div class="fs-12 mb-2">
                                <div class="mb-1">
                                    <span class="text-gray-800"><?php echo e(__("Payments are accepted:")); ?></span>
                                    <span class="fw-bold"><?php echo e(get_option("affiliate_types_of_payments", "")); ?></span>
                                </div>
                                <div class="text-left">
                                    <span class="text-gray-800"><?php echo e(__("A minimum withdrawal amount:")); ?></span>
                                    <span class="text-danger fw-bold">
                                        $<?php echo e(Affiliate::info("min_withdrawal")); ?>

                                </span>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-dark w-100"><?php echo e(__("Send Request")); ?></button>
                        </div>
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between align-items-center w-100 gap-8">
                            <div class="d-flex gap-16 align-items-center">
                                <div class="fw-5"><?php echo e(__("Payout Request")); ?></div>
...
<?php $__env->startSection('script'); ?>
                    ...
                    render: function (data, type, row) {
                        switch(data) {
                          ...
                          case 2:
                            ...
                            var status_text = "<?php echo e(__("Rejected")); ?>";
                        ...
                        return `
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end border-1 border-gray-300 px-2 w-100 max-w-125">
                                    ...
                                    <li>
                                        <a class="dropdown-item p-1 rounded d-flex gap-8 fw-5 fs-14 b-r-6 actionItem" data-id="${row.RecordID}" href="<?php echo e(module_url("status/pending")); ?>" data-call-success="Main.DataTable_Reload('#<?php echo e($Datatable['element']); ?>')">
                                            <span class="size-16 me-1 text-center"><i class="fa-light fa-eye"></i></span>
    ...
    Main.Chart('pie', [
        { name: "<?php echo e(__('Pending')); ?>", y: <?php echo e(floatval($affiliate_info["pending_commission"])); ?>, color: '#f59e0b' },
        { name: "<?php echo e(__('Approved')); ?>", y: <?php echo e(floatval($affiliate_info["approved_commission"])); ?>, color: '#22c55e' },
        { name: "<?php echo e(__('Reject')); ?>", y: <?php echo e(floatval($affiliate_info["rejected_commission"])); ?>, color: '#ef4444' }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppAffiliate/resources/views/index.blade.php ENDPATH**/ ?>