...
<?php $component = App\View\Components\SubHeader::resolve(['title' => ''.e(__('Manage Handles')).'','description' => ''.e(__('Effortlessly Manage and Organize All Your Handles')).'','count' => $total] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        <div class="d-flex gap-8">
            <a class="btn btn-dark btn-sm actionItem" href="<?php echo e(module_url("update")); ?>" data-popup="handleModal" data-call-success="Main.ajaxScroll(true);">
...
<div class="container pb-3">
    ...
    <div class="container px-4">
        ...
        <div class="ajax-scroll" data-url="<?php echo e(module_url("list")); ?>" data-resp=".handle-list" data-scroll="document">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp82\htdocs\pando-laravel\modules/AppHandles\resources/views/index.blade.php ENDPATH**/ ?>