<div class="content_left flex flex-col justify-between flex-1 px-8 pt-13 bg-white z-10">
    ...
    <div class="col-md-8 mx-auto self-center">
        <a class="mb-0 inline-block" href="<?php echo e(url('')); ?>">
            <img class="h-20" src="<?php echo e(url( get_option("website_logo_brand_dark ", asset('public/img/logos.png')) )); ?>" alt="">
        </a>
        ...
        <h3 class="mb-9 text-xl font-medium text-white font-heading leading-normal mb-3">
            <?php echo e(__("Created by social media managers just like you.")); ?>
		...
		<div class="col-md-8 mx-auto self-end">
			<img class="img-fluid mx-auto px-5" src="<?php echo e(theme_public_asset('images/headers/girl.png')); ?>" alt="">
		</div>
	</div>
</div><?php /**PATH C:\xampp82\htdocs\pando-laravel\resources\themes\guest\nova\resources\views/partials/login-screen.blade.php ENDPATH**/ ?>