<div class="tiktok-card border rounded bg-black text-white overflow-hidden position-relative">
    ...
    <div class="d-flex align-items-center p-3">
        <img src="<?php echo e(theme_public_asset('img/default.png')); ?>" class="rounded-circle me-2 cpv-avatar" width="32" height="32">
        <div>
            <div class="fw-bold fs-14 cpv-name"><?php echo e(__("Your name")); ?></div>
            <div class="fs-12 text-white"><?php echo e(date("M j")); ?></div>
        </div>
    </div>
    ...
    <div class="px-3 px-1">
        ...
        <div class="fs-12 text-gray-600 mb-2">🎵 <?php echo e(__('Original sound - TikTok')); ?></div>
    </div>
...
</div><?php /**PATH C:\xampp82\htdocs\pando-laravel\modules/AppChannelTiktokProfiles\resources/views/preview.blade.php ENDPATH**/ ?>