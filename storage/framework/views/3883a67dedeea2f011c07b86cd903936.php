...
<?php if($folder): ?>
<input type="radio" class="d-none form-check-input ajax-scroll-filter<?php echo e($file_id_slug); ?>" name="folder_id" value="<?php echo e($folder->id_secure); ?>" checked>
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
        <label class="fs-12 text-primary fw-5 text-hover-primary pointer" id="breadcrumb_folder_0">
            ...
            <input class="d-none form-check-input ajax-scroll-filter<?php echo e($file_id_slug); ?>" type="radio" name="folder_id" value="0" id="breadcrumb_folder_0">
        </label>
    </li>
    <?php $__currentLoopData = $parent_folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class="breadcrumb-item">
            <label class="fs-12 text-primary fw-5 text-hover-primary-900 pointer" id="breadcrumb_folder_<?php echo e($parent->id_secure); ?>">
                ...
                <input class="d-none form-check-input ajax-scroll-filter<?php echo e($file_id_slug); ?>" type="radio" name="folder_id" value="<?php echo e($parent->id_secure); ?>" id="breadcrumb_folder_<?php echo e($parent->id_secure); ?>">
            </label>
        </li>
    ...
    <div class="col-4 col-md-3 px-2">
        <div class="ratio ratio-1x1 mb-3">
            <label class="d-flex flex-column flex-fill w-100 bg-light border b-r-10 w-100 pointer mb-3" for="folder_<?php echo e($value->id_secure); ?>">
                <input class="d-none form-check-input ajax-scroll-filter<?php echo e($file_id_slug); ?>" type="radio" name="folder_id" value="<?php echo e($value->id_secure); ?>" id="folder_<?php echo e($value->id_secure); ?>">
                    ...
                    <div>
                        <div class="btn-group position-static">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-1 border-gray-300 px-1 w-100 max-w-120 min-w-120">
                                <li>
                                    <a class="dropdown-item px-2 p-t-4 p-b-4 rounded d-flex gap-8 fw-5 fs-13 actionItem" href="<?php echo e(module_url("update_folder")); ?>" data-popup="updateFolderModal" data-call-success="Main.ajaxScroll(true, <?php echo e($file_id); ?>)"
                                        <span class="text-truncate-1"><?php echo e(__('Edit Image')); ?></span>
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <a class="dropdown-item px-2 p-t-4 p-b-4 rounded d-flex gap-8 fw-5 fs-13 actionItem" href="<?php echo e(url_admin("files/destroy")); ?>" data-id="" data-call-success="Main.ajaxScroll(true, <?php echo e($file_id); ?>)">
                                        <span class="text-truncate-1"><?php echo e(__('Delete')); ?></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
...
<?php if($files): ?>
    ...
    <div class="col-4 col-md-3 px-2">
        <div class="file-item w-100 ratio ratio-1x1 min-h-80 mb-3 border b-r-6" data-id="file_<?php echo e($value->id_secure); ?>" data-name="medias">
            <label class="d-flex flex-column flex-fill" for="<?php echo e($value->id_secure); ?>">
                <div class="position-absolute r-6 t-6 zIndex-1">
                    <div class="form-check form-check-sm">
                        <input class="form-check-input" name="id[]" type="checkbox" value="<?php echo e(Media::url($value->file)); ?>" id="file_<?php echo e($value->id_secure); ?>">
                    </div>
                </div>
                    ...
                    <div>
                        <div class="btn-group position-static">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-1 border-gray-300 px-1 wp-100 max-w-150 min-w-150 text-truncate-1">
                                ...
                                <li>
                                    <button type="button" class="dropdown-item py-2 px-2 rounded d-flex gap-8 fs-12 text-truncate-1 editImage" data-file="<?php echo e(Media::url($value->file)); ?>" data-file-id="<?php echo e($file_id); ?>" data-id="<?php echo e($value->id_secure); ?>">
                                        <span class="size-16 text-center"><i class="fa-light fa-edit"></i></span>
                                        <span class="fw-5 text-truncate-1"><?php echo e(__("Edit Image")); ?></span>
                                    </button>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <?php endif; ?>
                                <li>
                                    <a class="dropdown-item py-2 px-2 rounded d-flex gap-8 fs-12 text-truncate-1 actionItem" href="<?php echo e(module_url("destroy")); ?>" data-id="<?php echo e($value->id_secure); ?>" data-call-success="Main.ajaxScroll(true, <?php echo e($file_id); ?>)">
                                        <span class="size-16 text-center"><i class="fa-light fa-trash-can"></i></span>
                                        <span class="fw-5 text-truncate-1"><?php echo e(__("Delete")); ?></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
...
<?php endif; ?><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppFiles/resources/views/popup_list.blade.php ENDPATH**/ ?>