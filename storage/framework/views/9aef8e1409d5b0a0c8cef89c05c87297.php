...
<?php $component->withAttributes([]); ?>
        <div class="d-flex gap-8">
            <a class="btn btn-dark btn-sm actionItem" href="<?php echo e(module_url("update")); ?>" data-popup="hashtagModal" data-call-success="Main.ajaxScroll(true);">
...
<div class="container pb-3">
    ...
    <div class="container px-4">
        ...
        <div class="ajax-scroll" data-url="<?php echo e(module_url("list")); ?>" data-resp=".hashtag-list" data-scroll="document">
