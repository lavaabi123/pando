<?php if( $handles->Total() > 0 ): ?>

	<?php $__currentLoopData = $handles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-3 mb-4">
	    <label class="card shadow-none" for="handle_<?php echo e($value->id_secure); ?>">
	    		...
	    		<div class="card-toolbar d-flex gap-16">
	    			<div class="btn-group position-static">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end border-1 border-gray-300 px-1 w-100 max-w-120 min-w-120">
                            <li>
                                <a class="dropdown-item px-2 p-t-2 p-b-2 rounded d-flex align-items-center gap-8 fw-5 fs-13 actionItem" href="<?php echo e(module_url("update")); ?>" data-id="<?php echo e($value->id_secure); ?>" data-popup="handleModal" data-call-success="">
                    ...
                    <input class="form-check-input checkbox-item" type="checkbox" name="id[]" value="<?php echo e($value->id_secure); ?>" id="handle_<?php echo e($value->id_secure); ?>">
	    		</div>
	    	</div>
...
<?php else: ?>
	<div class="d-flex flex-column align-items-center justify-content-center py-5 my-5">
	    ...
	    <div class="fw-semibold fs-5 mb-2 text-gray-900">
	        <?php echo e(__('No Handles Yet')); ?>

	    </div>
	    <div class="text-body-secondary mb-4 text-center max-w-500">
	        <?php echo e(__('Start saving your favorite handles to reuse and streamline your content creation process.')); ?>

	    </div>
	    <a class="btn btn-dark actionItem" href="<?php echo e(module_url("update")); ?>" data-popup="handleModal" data-call-success="Main.ajaxScroll(true);">
	        <i class="fa-light fa-plus me-1"></i> <?php echo e(__('Add new handle')); ?>

	    </a>
	</div>
<?php endif; ?><?php /**PATH C:\xampp82\htdocs\pando-laravel\modules/AppHandles\resources/views/list.blade.php ENDPATH**/ ?>