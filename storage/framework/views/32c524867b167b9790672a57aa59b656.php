...
<?php else: ?>
	<div class="d-flex flex-column align-items-center justify-content-center py-5 my-5">
	    ...
	    <div class="fw-semibold fs-5 mb-2 text-gray-900">
	        <?php echo e(__('No Brands Yet')); ?>

	    </div>
	    <div class="text-body-secondary mb-4 text-center max-w-500">
	        <?php echo e(__('Create brands to easily organize and manage your channels for better workflow efficiency.')); ?>
	    ...
	    <a class="btn btn-dark actionItem" href="<?php echo e(module_url("update")); ?>" data-popup="groupModal" data-call-success="Main.ajaxScroll(true);">
	        <i class="fa-light fa-plus me-1"></i> <?php echo e(__('Add new brand')); ?>

	    </a>
	</div>
<?php endif; ?><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppBrands/resources/views/list.blade.php ENDPATH**/ ?>