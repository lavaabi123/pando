        ...
        <div class="d-flex gap-8">
            ...
            <div class="d-flex flex-column wp-100">
                <div class="d-flex align-items-center gap-8">
                    ...
                    <span class="text-gray-600 fw-5 d-block fs-12">@<span class="cpv-username"><?php echo e(__("username")); ?></span></span>
                    <span class="text-gray-600 fs-10 d-flex align-items-center m-t--7"><i class="fa-solid fa-period"></i></span>
                    <span class="text-gray-600 fw-semibold d-block fs-12"><?php echo e(date("M j")); ?></span>
                </div>
                <div class="mt-2 mb-2">
...
</script><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppChannelXProfiles/resources/views/preview.blade.php ENDPATH**/ ?>