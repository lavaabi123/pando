<div class="modal fade" id="updateMemberModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content actionForm" action="<?php echo e(module_url("save")); ?>" data-call-success="Main.closeModal('updateMemberModal'); Main.ajaxScroll(true);">
            <input type="text" class="d-none" name="type" value="0">
            <div class="modal-header">
                <h1 class="modal-title fs-16"><?php echo e(__("Member Permissions")); ?></h1>
            ...
            <div class="modal-body p-4">
                ...
                <input type="hidden" name="id" value="<?php echo e($member->id_secure ?? 0); ?>">
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<div class="mb-2">
							...
							<input type="text" value="<?php echo e($tmember->fullname); ?>" name="fullname" class="form-control" placeholder="<?php echo e(__('Enter full name')); ?>" required>
						</div>
						<!-- Username -->
						<div class="mb-2">
							<label for="username" class="form-label"><?php echo e(__("Username")); ?></label>
							<input type="text" value="<?php echo e($tmember->username); ?>" id="username" name="username" class="form-control" placeholder="<?php echo e(__('Choose a username')); ?>" required>
						</div>						
 						<div class="mb-2">
		                  	<label for="email" class="form-label"><?php echo e(__('User Email')); ?></label>
	                     	<input placeholder="<?php echo e(__('Enter user email address')); ?>" class="form-control" name="email" id="email" type="email" value="<?php echo e($tmember->email); ?>" required>
		                </div>
						<!-- Password -->
						<div class="mb-2">
							<label for="password" class="form-label"><?php echo e(__("Password")); ?></label>
							<input type="password" id="password" name="password" class="form-control" placeholder="<?php echo e(__('Enter your password')); ?>">
						</div>
						<!-- Confirm Password -->
						<div class="mb-4">
							<label for="password_confirmation" class="form-label"><?php echo e(__("Confirm Password")); ?></label>
							<input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="<?php echo e(__('Re-enter your password')); ?>">
						</div>
...
</div><?php /**PATH C:\xampp82\htdocs\pando-laravel\modules/AppTeams\resources/views/update.blade.php ENDPATH**/ ?>