...
<head>
    ...
    :root{
      ...
      --sp-primary:  <?php echo e($primaryHex); ?>;
      --sp-secondary:<?php echo e($secHex); ?>;
    }
    </style>
</head>
<body class="<?php echo e($theme); ?>">
    ...
    <script type="text/javascript" src="<?php echo e(theme_public_asset('js/main.js')); ?>?version=9.0.21"></script>	
