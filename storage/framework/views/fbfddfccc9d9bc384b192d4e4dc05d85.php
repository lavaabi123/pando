<?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card hp-100 approval-card border-0 shadow-sm">
            ...
            <div class="card-footer fs-12 d-flex justify-content-center gap-8">
	            ...
	            <div class="p-12 text-end mb-1">
					<a href="<?php echo e(url_app("publishing/move_to_queue")); ?>" 
					   class="d-flex flex-fill gap-8 align-items-center justify-content-center text-gray-900 text-hover-primary fw-5 btn btn-primary actionItem" 
					   data-call-success="Main.ajaxScroll(true)"
					   data-id="<?php echo e($value->id_secure); ?>" 
