                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-4">
                            ...
                            <input class="form-control" name="youtube_api_key" id="youtube_api_key" type="text" value="<?php echo e(get_option("youtube_api_key", "")); ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppChannelYoutubeChannels/resources/views/settings.blade.php ENDPATH**/ ?>