        ...
        <form class="actionForm max-w-md mx-auto w-full space-y-5" action="<?php echo e(module_url('do_signup')); ?>" method="POST" data-loading="1">
			...
			<button type="submit" id="signup-submit-btn" class="w-full btn btn-primary submit-btn">
				...
				<span class="btn-loader" style="display: none;">
					<i class="fas fa-spinner fa-spin"></i> <?php echo e(__("Signing Up...")); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkEmailAvailability(email) {
        fetch('<?php echo e(url("auth/check-email")); ?>', {
            method: 'POST',
            headers: {
    ...
    function checkUsernameAvailability(username) {
        fetch('<?php echo e(url("auth/check-username")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    function checkPasswordMatch() {
        ...
        if (password === passwordConfirmation) {
            passwordsMatch = true;
            passwordConfirmationMessage.textContent = '✓ <?php echo e(__("Passwords match")); ?>';
            ...
            passwordsMatch = false;
            passwordConfirmationMessage.textContent = '✗ <?php echo e(__("Passwords do not match")); ?>';
...
</script><?php /**PATH C:\xampp82\htdocs\pando-laravel\resources\themes\guest\nova\resources\views/auth/signup.blade.php ENDPATH**/ ?>