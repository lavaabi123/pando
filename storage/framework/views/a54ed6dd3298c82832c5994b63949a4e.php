...
<footer class="footer bg-white gap-0">
      <div class="container py-3">
			<div class="d-flex justify-content-center items-center w-100">
				<a class="btn btn-primary" href="<?php echo e(url('terms-of-service')); ?>"><?php echo e(__("Terms & Conditions")); ?></a>
				<a class="btn btn-primary" href="<?php echo e(url('privacy-policy')); ?>"><?php echo e(__("Privacy Policy")); ?></a>
			</div>
      </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 text-md-start text-center mt-0">
              <p class="mb-0">Copyright © <?php echo e(date('Y')); ?>, <?php echo e(__("All Rights Reserved")); ?></p>
            </div>
