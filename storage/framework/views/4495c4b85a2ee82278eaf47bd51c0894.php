        ...
        <div class="d-flex align-items-center gap-8">
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <div class="flex-grow-1 me-2 text-truncate">
                    <a href="javascript:void(0);" class="text-gray-900 text-hover-primary fs-14 fw-bold cpv-name"><?php echo e(__("Your name")); ?></a>
                    <span class="text-muted fw-semibold d-block fs-12"><?php echo e(date("M j")); ?> <span class="position-relative t--3 fw-9 me-1">.</span><i class="fa-solid fa-earth-americas"></i></span> 
                </div>
            </div>
        </div>
    ...
    <div class="mb-0">
        ...
        <div class="cpv-link d-flex justify-content-start d-none border b-r-10 m-3">
            <div class="cpv-link-img img-wrap w-100 size-120 size-child b-r-10 m-3 img-wrap">
                <img src="<?php echo e(theme_public_asset( "img/default.png" )); ?>" class="w-100 b-r-10">
            </div>
    ...
    <div class="border-top px-3 py-2">
        <div class="d-flex justify-content-between">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <div class="flex-grow-1 me-2 text-truncate">
                        <span class="text-gray-800 fs-12 fw-bold"><?php echo e(__("Send")); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/royalinkdevelopm/public_html/pando.royalinkdevelopment.com/modules/AppChannelLinkedinProfiles/resources/views/preview.blade.php ENDPATH**/ ?>