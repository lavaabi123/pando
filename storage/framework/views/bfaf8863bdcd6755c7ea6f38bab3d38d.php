                                        ...
                                        <ul class="list-unstyled symbol py-1">
                                            <?php $__currentLoopData = $brands_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="py-1 d-flex">
                                                    <input type="checkbox" name="brand[]" value="<?php echo e($brand->id); ?>" class="me-2">
                                    ...
                                    <?php if(!empty($users_list)): ?>
                                        <ul class="list-unstyled symbol py-1">
                                            <?php $__currentLoopData = $users_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="py-1 d-flex">
                                                    <input type="checkbox" name="users[]" value="<?php echo e($user->id); ?>" class="me-2">
                                                    <label class="form-check-label"><?php echo e($user->fullname); ?></label>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    <?php endif; ?>
                        ...
                        <div class="accordion-item b-r-25 border overflow-hidden mb-3">
                            ...
                            <div id="flush-collapseType" class="accordion-collapse collapse" aria-labelledby="flush-headingType">
                                  <div class="accordion-body">
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('facebook')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Messenger</span></label></li>
									  <li class="text-truncate d-flex me-2 py-1">
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('facebook')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Mentions</span></label></li>
									  <li class="text-truncate d-flex me-2 py-1">
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('facebook')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Reviews</span></label></li>
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('instagram')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Comments</span></label></li>
									  <li class="text-truncate d-flex me-2 py-1">
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('instagram')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Messenger</span></label></li>
									  <li class="text-truncate d-flex me-2 py-1">
									  ...
									  <div class="post-account me-2"><?php echo e(get_social_media_image('instagram')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Tags</span></label></li>
									  
									  <!-- For X -->
									 <!-- <li class="text-truncate d-flex me-2 py-1">
									  <input type="checkbox" name="eventType[]" class="custom-control-input me-2" value="twitter_Messenger">
									  <label class="custom-control-label font-normal d-flex w-100" for="if_IM">
									  <div class="post-account me-2"><?php echo e(get_social_media_image('x')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Direct Messages</span></label></li>-->
									  ...
									  <label class="custom-control-label font-normal d-flex w-100" for="if_IComments">
									  <div class="post-account me-2"><?php echo e(get_social_media_image('linkedin')); ?></div><span class="text-truncate text-dark pr-1" style="top: auto;">Comments</span></label></li>
								...
								<div href="javascript: void(0)" class="text-gray-400 text-hover-primary fs-14 fw-bold mb-2" role="button" onclick="clear_tag_selected()"><span>Clear Selected</span></div>
                                    ...
                                    <?php if(!empty($tags_list)): ?>
                                        <ul class="list-unstyled symbol py-1 load-tag-list">
                                            <?php $__currentLoopData = $tags_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="py-1 d-flex">
                                                    <input type="checkbox" name="tags[]" value="<?php echo e($tag->id); ?>" class="me-2">
                                                    <label class="form-check-label"><?php echo e($tag->tag_name); ?></label>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    <?php endif; ?>
